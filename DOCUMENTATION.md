...
- **Windows:** Download `CapShorts_1.1.0_x64-setup.exe` (or enterprise `.msi`) from [GitHub Releases](https://github.com/thealiraza2/CapShorts/releases/latest).
- **macOS:** Download `CapShorts_1.1.0_universal.dmg` (supports Apple Silicon M1/M2/M3/M4 & Intel Macs).
...
Yes. The macOS installer (`CapShorts_1.1.0_universal.dmg`) is compiled as a Universal 2 binary supporting both native Apple Silicon (ARM64) and Intel architectures.
